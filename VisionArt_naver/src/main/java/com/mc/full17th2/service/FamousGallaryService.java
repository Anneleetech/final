...
public class FamousGallaryService {
    ...
    private final String uploadPath="/usr/mydir/visionart/attachment/fg";
    ...
    public HashMap<String,Object> getPost(int postId){
        ...
        List<DBCommentDTO> comments=dao.getFamousGallaryComments(postId);
    ...
    // 댓글 등록
    public HashMap<String,Object> addComment(DBCommentDTO data){
        HashMap<String,Object> result=new HashMap<>();

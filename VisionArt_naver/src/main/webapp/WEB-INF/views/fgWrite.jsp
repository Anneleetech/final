        ...
        <div class="container">
            <form action="/fg/write/save" id="postForm" method="post" enctype="multipart/form-data">
                ...
                <div class="post">
                    ...
                    <div class="form-group half-width">
                        <p class="p">작가명</p>
                        <input type="text" id="artistSearchName" name="artistSearchName" required disabled>
                        <input type="hidden" id="artistSearchId" name="artistSearchId" required>
